Rails.application.configure do
  ...
  config.action_cable.url = "ws://#{Boyutluseyler.credentials[:website]}/cable"
  ...
  # config.active_job.queue_name_prefix = "boyutluseyler_#{Rails.env}"
  ...
  # https://sendgrid.com/docs/API_Reference/SMTP_API/errors_and_troubleshooting.html
