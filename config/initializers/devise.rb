...
Devise.setup do |config|
  ...
  config.mailer_sender = Boyutluseyler.credentials[:mail_sender]
  ...
  config.authentication_keys = [:login] # default is email
  ...
  config.case_insensitive_keys = %i[email email_confirmation]
  ...
  # config.pepper = 'hashed_password'

  # Send a notification to the original email when the user's email is changed.
  config.send_email_changed_notification = true # default is false

  # Send a notification email when the user's password is changed.
  config.send_password_change_notification = true # default is false
  ...
  # https://github.com/DavyJonesLocker/client_side_validations/wiki/Devise#email-validation
  # TODO: move to Boyutluseyler::Regex module
  # * Test: https://rubular.com/r/ZsA2dMdumkEhQy
  # * Javascript compatible email regex
  ...
  # is failed attempts.
  config.maximum_attempts = Rails.env.test? ? 3 : 10 # default is 20
  ...
  config.reset_password_within = 2.days # default is 6.hours

  # When set to false, does not sign a user in automatically after their password is
  # reset. Defaults to true, so a user is signed in automatically after a reset.
  config.sign_in_after_reset_password = false # default is true
